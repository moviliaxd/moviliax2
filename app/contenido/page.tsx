          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article) => (
              <Link
                ...
                className="group"
              >
                <article className="bg-gradient-to-br from-[#0A0F2C] to-[#0D0D0D] rounded-xl overflow-hidden border border-[#00E0FF]/20 hover:border-[#00E0FF]/50 transition-all">
                  {/* Imagen placeholder */}
