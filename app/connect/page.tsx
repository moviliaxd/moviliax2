...
import { Battery, Building2, Truck, Bot, Briefcase, Globe, MessageSquare, Users, Calendar, MapPin, Clock } from 'lucide-react'
...
// Datos separados para fácil mantenimiento
const STATS = [
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-4 py-20">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="#foros" className="btn-secondary inline-flex items-center justify-center gap-2">
              Ver Cómo Funciona
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FORUMS.map((forum, i) => {
              ...
              const forumSlug = forum.title.toLowerCase().replace(/\s+/g, '-')
              return (
                <Link 
                  key={i}
                  href={`/connect/foros/${forumSlug}`}
                  className="content-card group hover:scale-[1.02] transition-transform focus:outline-none focus:ring-2 focus:ring-cian-electrico rounded-lg block"
                >
                  <article>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {GROUPS.map((group, i) => {
              ...
              return (
                <Link
                  key={i}
                  href={`/connect/grupos/${groupSlug}`}
                  className="content-card hover:border-cian-electrico/50 transition-all focus:outline-none focus:ring-2 focus:ring-cian-electrico rounded-lg block"
                >
                  <article>
